...
const (
	...
	CheckoutService_GeneratePayment_FullMethodName   = "/hipstershop.CheckoutService/GeneratePayment"
	CheckoutService_GenerateSalesTax_FullMethodName  = "/hipstershop.CheckoutService/GenerateSalesTax"
	CheckoutService_GenerateCartEmpty_FullMethodName = "/hipstershop.CheckoutService/GenerateCartEmpty"
)
...
func (c *checkoutServiceClient) GeneratePayment(ctx context.Context, in *GeneratePaymentRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, CheckoutService_GeneratePayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *checkoutServiceClient) GenerateSalesTax(ctx context.Context, in *GenerateSalesTaxRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, CheckoutService_GenerateSalesTax_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *checkoutServiceClient) GenerateCartEmpty(ctx context.Context, in *GenerateCartEmptyRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, CheckoutService_GenerateCartEmpty_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCheckoutServiceServer) GeneratePayment(context.Context, *GeneratePaymentRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GeneratePayment not implemented")
}
func (UnimplementedCheckoutServiceServer) GenerateSalesTax(context.Context, *GenerateSalesTaxRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateSalesTax not implemented")
}
func (UnimplementedCheckoutServiceServer) GenerateCartEmpty(context.Context, *GenerateCartEmptyRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateCartEmpty not implemented")
}
...
func _CheckoutService_GeneratePayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CheckoutService_GeneratePayment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CheckoutService_GenerateSalesTax_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CheckoutService_GenerateSalesTax_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CheckoutService_GenerateCartEmpty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CheckoutService_GenerateCartEmpty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

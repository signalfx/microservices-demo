...
class CheckoutServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.PlaceOrder = channel.unary_unary(
                ...
                _registered_method=True)
        self.GeneratePayment = channel.unary_unary(
                '/hipstershop.CheckoutService/GeneratePayment',
                request_serializer=demo__pb2.GeneratePaymentRequest.SerializeToString,
                response_deserializer=demo__pb2.Empty.FromString,
                _registered_method=True)
        self.GenerateSalesTax = channel.unary_unary(
                '/hipstershop.CheckoutService/GenerateSalesTax',
                request_serializer=demo__pb2.GenerateSalesTaxRequest.SerializeToString,
                response_deserializer=demo__pb2.Empty.FromString,
                _registered_method=True)
        self.GenerateCartEmpty = channel.unary_unary(
                '/hipstershop.CheckoutService/GenerateCartEmpty',
                request_serializer=demo__pb2.GenerateCartEmptyRequest.SerializeToString,
                response_deserializer=demo__pb2.Empty.FromString,
                _registered_method=True)
...
class CheckoutServiceServicer:
    ...
    def GeneratePayment(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def GenerateSalesTax(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def GenerateCartEmpty(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CheckoutServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GeneratePayment': grpc.unary_unary_rpc_method_handler(
                    servicer.GeneratePayment,
                    request_deserializer=demo__pb2.GeneratePaymentRequest.FromString,
                    response_serializer=demo__pb2.Empty.SerializeToString,
            ),
            'GenerateSalesTax': grpc.unary_unary_rpc_method_handler(
                    servicer.GenerateSalesTax,
                    request_deserializer=demo__pb2.GenerateSalesTaxRequest.FromString,
                    response_serializer=demo__pb2.Empty.SerializeToString,
            ),
            'GenerateCartEmpty': grpc.unary_unary_rpc_method_handler(
                    servicer.GenerateCartEmpty,
                    request_deserializer=demo__pb2.GenerateCartEmptyRequest.FromString,
                    response_serializer=demo__pb2.Empty.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class CheckoutService:
    ...
    def GeneratePayment(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.CheckoutService/GeneratePayment',
            demo__pb2.GeneratePaymentRequest.SerializeToString,
            demo__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GenerateSalesTax(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.CheckoutService/GenerateSalesTax',
            demo__pb2.GenerateSalesTaxRequest.SerializeToString,
            demo__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GenerateCartEmpty(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.CheckoutService/GenerateCartEmpty',
            demo__pb2.GenerateCartEmptyRequest.SerializeToString,
            demo__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
